...
df = pd.read_excel(r'C:\Users\Sanuj Goyal\OneDrive\Desktop\Population Prediction Project\USA_output.xlsx')
print(df)
...
natural_change_rate = df['Natural change (per 1,000)'].tolist()
...
# Bar chart for population vs year
