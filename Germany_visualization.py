...
df = pd.read_excel(r'C:\Users\Sanuj Goyal\OneDrive\Desktop\Population Prediction Project\Germany_output.xlsx')
print(df)

################################## Converting string data to numeric data#############################################

df['Average population'] = df['Average population'].str.replace(
    ',', '').astype(int)
